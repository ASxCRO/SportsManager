...
var jwtUtil = /** @class */ (function () {
    ...
    jwtUtil.signAccessToken = function (payload) {
        return new Promise(function (resolve, reject) {
            jsonwebtoken_1.default.sign({ payload: payload }, accessTokenSecret, {}, function (err, token) {
                if (err) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        jsonwebtoken_1.default.verify(token, accessTokenSecret, function (err, payload) {
                            if (err) {
